        ...
        <>
            <div className={styles.font}>
                <div className={styles.heroSmall}>
                    <div className={styles.title}>{props.info.movieTitle}</div>
                </div>
                <div className={styles.heroContainer}>
                    <div className={styles.content}>
                        ...
                        <div className={styles.info}>
                            <span>
                                <span className={styles.imdbContainer}><span className={styles.imdb}>IMDb</span><span className={styles.imdbRating}>{props.info.imdb}</span></span>
                                <span>{props.info.duration}</span>
                                <span>{props.info.releaseYear}</span>
                            </span>
                ...
                <div className={styles.movieInfo}>
                    ...
                    <div className={styles.container}>
                        ...
                        {showMoreInfo && (<div className={styles.cell}>
                            ...
                            <div className={styles.content}><div>Viewer: {props.info.tomatometer.viewer}</div><div>Critic: {props.info.tomatometer.critic}</div></div>
                        </div>)}
                        {showMoreInfo && (<div className={styles.cell}>
