    ...
    <div style={{backgroundColor: "#101010", display: "block"}}>
      ...
      <div className={styles.edit_button}>
        ...
        <div className={styles.favorites}>
          ...
          <div className={styles.favorites_card}>{(favMovie && favMovie.length>0) ? <GeneralSlider movie={[...favMovie].reverse()} />:<div className={styles.nothingToShow}><div><svg width="80px" height="80px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ff0000" stroke-width="1.248" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.288"></g><g id="SVGRepo_iconCarrier"><path d="M19 5L18.0864 5.91358M5 19L8.21252 15.7875M18.0864 5.91358C16.3142 4.5616 13.7913 4.69173 12.1544 6.42726L12 6.59097L11.8456 6.42726C9.86801 4.33053 6.59738 4.57698 4.91934 6.94915C3.42999 9.05459 3.78668 12.0335 5.725 13.6776L8.21252 15.7875M18.0864 5.91358L8.21252 15.7875M9.64206 17L12 19L18.275 13.6776C19.9081 12.2924 20.4185 9.95956 19.6479 8" stroke="#ff2e2e" stroke-linecap="round" stroke-linejoin="round"></path></g></svg></div><div>Movies liked by you will display here.</div></div>}</div>
        </div>
