            ...
            <div className={styles.font}>
                ...
                <div className={styles.heroContainer}>
                    <div className={styles.content}>
                        ...
                        <div className={styles.description} id="description">{descriptionUpdated}{!isExpanded && (<button className={styles.readMore} onClick={handleReadMore}>  ... read more</button>)}</div>
